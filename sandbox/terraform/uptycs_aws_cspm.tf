locals {
  ...
  default_external_id = "1cfe95fd-6b84-441d-a691-0a163797742a"
  external_id = lookup(local.external_ids, data.aws_caller_identity.current.account_id, local.default_external_id)
}
